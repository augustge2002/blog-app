    ...
    <el-container class="me-allct-container">
      <el-main>
        <el-tabs v-model="activeName">
          <el-tab-pane label="Post Categories" name="category">
    ...
    methods: {
      ...
      getCategorys() {
        ...
        getAllCategorysDetail().then(data => {
          ...
          if (error !== 'error') {
            that.$message({type: 'error', message: 'Failed to Load Posts Categories', showClose: true})
          }
        })
      },
      getTags() {
