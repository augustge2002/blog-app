<template>
  <div id="register" v-title data-title="Sign Up">
    ...
    <div class="me-login-box me-login-box-radius">
      ...
      <el-form ref="userForm" :model="userForm" :rules="rules">
        ...
        <el-form-item size="small" class="me-login-button">
          <el-button type="primary" @click.native.prevent="register('userForm')">Sign Up</el-button>
        </el-form-item>
      </el-form>
      ...
      return {
        ...
        rules: {
          account: [
            ...
            {max: 10, message: 'No Longer Than 10 Characters', trigger: 'blur'}
          ],
          nickname: [
        ...
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            that.$store.dispatch('register', that.userForm).then(() => {
              that.$message({message: 'Succuessfully Signed Up', type: 'success', showClose: true});
